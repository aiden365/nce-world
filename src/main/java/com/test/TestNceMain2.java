...
public class TestNceMain2 {
    ...
    public static void methodListFour2(String[] args) {
        ...
        TestFour7.pad();
        TestFour7.output();
        TestFour11.description();
        TestFour8.complete();
        TestFour4.roll();
        TestFour7.item();
        TestFour6.may();
        TestFour5.conversion();
        TestFour3.content();
        TestFour5.control();
        TestFour5.country();
        TestFour4.region();
        ...
        TestFour1.ceiling();
        TestFour6.mean();
        TestFour8.connection();
        TestFour3.no();
        TestFour7.collection();
        TestFour6.hint();
        TestFour6.middle();
        TestFour1.submit();
        TestFour2.spare();
        ...
        TestFour8.average();
        TestFour5.preserve();
        TestFour7.dictionary();
        TestFour4.ensure();
        TestFour10.image();
        TestFour8.concrete();
        TestFour1.lazy();
        TestFour9.application();
        TestFour2.section();
        TestFour1.symbol();
        TestFour4.enlarge();
        TestFour7.dim();
        ...
        TestFour1.murder();
        TestFour1.murderer();
        TestFour1.mysterious();
        TestFour1.generally();
        TestFour1.mutton();
        TestFour1.nature();
        TestFour1.generation();
        TestFour1.genius();
        TestFour1.keyboard();
        TestFour1.kilogram();
        TestFour1.kiss();
