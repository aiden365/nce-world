...
public class ArtDeal {
     ...
     *
     * 1:30 P.M. I tell Norma to call John Danforth, the Republican senator from Missouri. I don’t know Danforth personally, but he’s one of the few senators who fought hard against the new tax bill. It’s probably too late, but I just want to congratulate him on having the courage of his convictions, even though it might cost him politically.
     *
     ...
     *
     * 2:30 P.M. Bill Fugazy calls. I like to call him Willie the Fug, but he doesn’t seem to appreciate it. Fugazy’s business is limousines, but he really should have been a broker. The guy knows everyone. He’s one of Lee Iacocca’s best friends, and he’s the person who recommended to the cardinal that he meet with me to discuss real estate and get to know each other better.
     *
     ...
     *
     * The point is that you can dream great dreams, but they’ll never amount to much if you can’t turn them into reality at a reasonable cost. At the time I built Trump Plaza in Atlantic City, banks were reluctant to finance new construction at all, because almost every casino up to then had experienced tens of millions of dollars in cost overruns. We brought Trump Plaza in on budget, and on time. As a result, we were able to open for Memorial Day weekend, the start of the high season. By contrast, Bob Guccione of Penthouse has been trying for the past seven years to build a casino on the Boardwalk site right next to ours. All he has to show for his efforts is a rusting half-built frame and tens of millions of dollars in lost revenues and squandered carrying costs.
     *
     * Even small jobs can get out of control if you’re not attentive. For nearly seven years I watched from the window of my office as the city tried to rebuild Wollman Rink in Central Park. At the end of that time, millions of dollars had been wasted and the job was farther from being completed than when the work began. They were all set to rip out the concrete and start over when I finally couldn’t stand it anymore, and I offered to do it myself. The job took four months to complete at a fraction of the city’s cost.
     *
     *
     *
     *
     ...
     *
     * One day, a number of years after we first bought the place, I was out visiting. I ran into my friend. “How are you doing, how are you feeling?” I asked. “Good, good,” he replied, but then he took me aside and whispered, “Donald, you are a friend of mine and I have to tell you, sell this job.” And I said, “Why?”
     *
     ...
     *
     * After we ate, I took Der and another friend back to my apartment, the tiny studio I was still living in on Third Avenue, and I asked him what he thought about my furniture. Some people would just have said, “Fantastic, great,” but Der didn’t do that. “There’s too much of it,” he said, and he started moving furniture around, and even pushed several pieces out into the hallway. When he finished, he’d managed to make the apartment look much bigger, which I liked.
     *
     ...
     *
     * I’ve already seen the proof. A. N. Pritzker, a wonderful man who was the patriarch of his family and who died recently, used to call me frequently when he came to New York. A.N. and his son Jay were very different men. What they had in common was brilliance, but where Jay keeps very much to himself, A.N. was extremely effusive and outgoing, almost a teddy bear. They were a perfect combination. A.N. built the foundation of the company from nothing, and he got the banks to back him not because he had great assets but because they loved him. Now the company has a huge base, and Jay, who is a much cooler personality, doesn’t need the banks to love him. He can be very tough and they still want to do business with him.
     *
     ...
     *
     * Instead, I set out to leverage my credibility. I told the owners of the sites that I was prepared to make a fair deal, and that unlike all the others before me, I was going to follow through. I pointed out that I had a strong track record when it came to developing property. I also suggested that I might be the only person around who still had the inclination to put this deal together at all. If they couldn’t come to an agreement with me, I said, they might be sitting on their property for many years to come.
     *
     ...
     *
     * The problem for me was that if I didn’t win some guarantees about completion of construction, I risked getting killed later on. Say, for example, that it turned out there was a major defect in the plumbing, or the air-conditioning system, and I was forced to rip it out. In a building this size, a major repair could easily run to many millions of dollars.
     *
     ...
     *
     * By the time I bought the New Jersey Generals in the fall of 1983, the league was already failing badly. It had lost nearly $30 million. The Generals alone, under the ownership of an Oklahoma oilman named J. Walter Duncan, had lost more than $2 million, not to mention nearly every game they’d played. In real estate terms, I was buying the South Bronx instead of Fifth Avenue and 57th Street.
     *
     ...
     *
     * By the time we got Sipe, we’d already lured away several other top NFL players. The first was Gary Barbaro, an All-Pro free safety from the Kansas City Chiefs, whom we signed on November 5. Signing Barbaro had a side benefit: it showed other NFL players that we were serious about paying top dollar to build a top team. On November 28 we signed Kerry Justin, who’d been a starting cornerback for the Seattle Seahawks. In December we signed a pair of linebackers from the Super Bowl-champion San Francisco Forty-niners, Willie Harper and Bobby Leopold. To protect Sipe, we signed a veteran offensive guard from Cincinnati named Dave Lapham.
     *
     ...
     *
     * I also liked the fact that Flutie had great media potential. He was good-looking, well-spoken, and gutsy—the sort of guy the press loves to write about. There were two minor problems. One was that the Generals already had a very talented quarterback named Brian Sipe. The other was that Doug Flutie stood just five feet ten and weighed only 170 pounds. A number of scouts were skeptical that he could make it in the pros, where virtually every defensive lineman is six feet six and weighs at least 260 pounds.
     *
     ...
     *
     * Sure enough, the tide turned, overnight. No sooner did the press jump on Koch’s case than he reversed field completely. Suddenly, the city was virtually begging me to take on the Wollman Rink job. On June 6, I sat down in my office with city officials, including Henry Stern, to negotiate the terms under which I’d rebuild the Wollman Rink. Until then, the city had insisted on competitive bidding, as is required on any city-financed construction job. I suggested a simple solution. I’d put up all of the money for the construction of the rink myself. In turn, I’d be reimbursed, over as many years as it took, from any profits the rink earned. In other words, I’d not only supervise construction, I’d also lend the city $3 million for an indeterminate period—and forever if the rink didn’t prove profitable.
     *
     ...
     *
     * What I liked most about Helmut was that he believed, as I did, that big can be beautiful. He liked spectacle. Less than three weeks after we first talked, he arrived in my office with a scale model of a project that incorporated the basic elements I’d told him I wanted, as well as several of his own. In the summer of 1985, I hired Jahn to be the project’s chief architect.
     *
     ...
     *
     * The irony is that Koch made his reputation by boasting about his integrity and incorruptibility. It doesn’t seem to occur to him that if the people he appoints prove to be corrupt, then in the end he must take the responsibility. To the contrary, at the first hint that any of his friends might be in trouble, Koch can’t run fast enough the other way. For example, when his close friend Donald Manes, the late Queens borough president, came under investigation and tried to commit suicide, Koch immediately called him “a crook,” even though Manes had yet to be indicted for anything. At the time, Manes was recovering in a hospital. Weeks later, he did succeed in killing himself.
     *
     ...
     *
     * I suggested a deal under which I’d build NBC’s headquarters myself, at a cost of between $300 million and $400 million. I’d also subsidize NBC’s rent for thirty years by charging only $15 a square foot, which is less than half the break-even rent. Finally, I’d agree to give to the city 25 percent of any profits Television City earned for a period of forty years. In return, I’d get a twenty-year tax abatement on my entire site. Even then, my savings would begin only when I got the project up, which was years away, at best. In the meantime, I’d be subsidizing NBC out of my own pocket, to the tune of at least $30 million a year.
     *
     ...
     *
     *
     * DONALD J. TRUMP is the very definition of the American success story, continually setting standards of excellence while expanding his interests in real estate, gaming, sports, and entertainment. Besides their collaboration on The Apprentice, Trump and NBC are also partners in the ownership and broadcast rights for the three largest beauty competitions in the world.
     *
     * Trump is the New York Times best-selling author of Think Like a Billionaire, How to Get Rich, Surviving at the Top, The Art of the Comeback, and The America We Deserve. These books have sold millions of copies.
     *
     * An ardent philanthropist, Trump is involved with numerous civic and charitable organizations. In June 2000 he received his greatest honor, given to him by the UJA Federation: He was named the Hotel and Real Estate Visionary of the Century.
     *
     * @param null
     * @return
     * @author chenjc
     * @date 2025-05-24 10:06
     */
}
