...
public class Sw {
    ...
    public static void main(String[] args) {
        String filePath = System.getProperty("user.dir").concat("/doc/sw.txt");
        ...
        int sectorIndex = 1;
        Map<Integer, List<String>> mmp = new HashMap<>();
        for (int i = 1; i <= ss.size(); i++) {
            if(i % 300 == 0){
                sectorIndex += 1;
            }

            mmp.computeIfAbsent(sectorIndex, k -> new ArrayList<>());
            mmp.get(sectorIndex).add(ss.get(i - 1));
        ...
        mmp.forEach((k,v) -> {
            ...
            log.info("*/");
            log.info("public static void sector"+k+"() {}");
     ...
     * In contrast to the Stoics, the Epicureans showed little or no interest in politics and the community. “Live in seclusion!” was the advice of Epicurus. We could perhaps compare his “garden” with our present-day communes. There are many people in our own time who have sought a “safe harbor”—away from society.
     ...
     * We said that the most important of the senses for Indo-Europeans was sight. How important hearing was to the Semitic cultures is just as interesting. It is no accident that the Jewish creed begins with the words: “Hear, O Israel!” In the Old Testament we read how the people “heard” the word of the Lord, and the Jewish prophets usually began their sermons with the words: “Thus spake Jehovah (God).”
     ...
     * Handing out the “remission of sins” in this way was totally unheard of. And what was even worse, he addressed God as “Father” (Abba). This was absolutely unprecedented in the Jewish community at that time. It was therefore not long before there arose a wave of protest against him among the scribes.
